...
function PrintElem()
{
	...
	if(mode=="cash")
	{
		 mywindow.document.write('<p>Please Pay Your Fee at the counter</p>');
	}
	else
	{
...
<center><strong><h2>ADMISSION FORM</h2></strong>
<?php
...
{
	echo "<center><div id='slip' >Your Admission Is Done<br><br>";
	...
	<table>
	<tr>
	<td><input type='radio' name='mode' onclick='update_mode(\"cash\")' />Cash  </td>
	<td><input name='mode' onclick='update_mode(\"online\")' type='radio' />Pay Online </td> </tr>
	</table>
...
else
{
	...
	echo "<input type='text' placeholder='Seats Available' name='seats' id='seats' readonly /></b><br><br>";
	echo "<input type='text' placeholder='Roll NO You Will Get' name='roll' id='roll' readonly /></b><br><br>";
	echo "<input type='text' name='fee' placeholder='Fees' id='fee' readonly /></b><br><br>";
	$reg=mysql_fetch_assoc($reg_data);
	echo "Name : <b>$reg[fname] $reg[lname] </b><br><br>";
	echo "Date Of Birth : <b>$reg[dob]</b><br><br>";
	echo "<input type='submit' name='submit' class='button button2' value='Proceed To Take Admission'>";
