	...
	while($row=mysql_fetch_assoc($result))
		{
			...
			echo "<span class='img1' style='float:left;padding-left:40px;' onmouseover='show($row[courseid])' onmouseout='hide($row[courseid])'>
			<p class='info' id='$row[courseid]' style='position:absolute;z-index:90;height:200px;width:200px;margin-left:9px;margin-top:9px;'>
			Course Name : $row[course_name]<br>
			Session : $row[session]<br>
			Seats Available :$row[seats]</p>
			<img src=images/$row[course_name].png style='height:220px;width:220px;' />
			</span>";
		}
